...
class CatchEnv(gym.Env):
    ...
    def get_board(self):
        return self.gen_obs(False).astype(int)
    ...
    def get_board_info(self):
        chr_mapping = {
            ...
            1: "O",
            2: "_",
            "text": "To play the game use 0 to do nothing, 1, 2 to move left or right\nscore: {}\nlives: {}".format(
                self.score, self.lives
            ),
            "mode": "atari",
            "sleep": 1,  # wait maximum of 1 second before proceeding...
        }
        return chr_mapping
